...
FILE	= webserv.cpp parsing/parsing.cpp parsing/configFile/Config.cpp execution/fast_poxi.cpp  http_par/parsing_request.cpp http_par/generate_responce.cpp
